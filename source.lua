...
Watermark = Watermark .. "\n@developer: zyzxti"
Watermark = Watermark .. "\n@contact: zyzxti#2047"
Watermark = Watermark .. "\n@usage: serializing tables to string / serializing json to serialized table | usefull to see refreshed stuff in modules or if ur executors doesnt not support decompile(...)"
